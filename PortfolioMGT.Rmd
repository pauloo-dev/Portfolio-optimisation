...
The histograms for NVDA, CMCSA, and EA returns reveal that the distributions deviate from normality, exhibiting leptokurtic behavior — characterized by a sharp peak and heavy tails. This is supported by the high kurtosis values observed for all three stocks. While the majority of returns cluster around zero, indicating limited daily price movements, the presence of fat tails suggests a higher likelihood of extreme returns compared to a normal distribution.
